...
export function RegisterForm() {
  ...
  if (state.status === "success") return <div className="rounded-xl border border-primary/20 bg-primary/5 p-7 text-center" role="status"><CheckCircle2 className="mx-auto h-11 w-11 text-primary" aria-hidden="true" /><h2 className="mt-4 text-headline-md font-headline-md text-on-surface">Form pendaftaran valid</h2><p className="mt-3 text-body-md leading-6 text-on-surface-variant">{state.message}</p><Link href="/masuk" className="mt-6 inline-flex rounded-lg bg-primary px-5 py-3 text-label-md font-label-md text-on-primary">Ke Halaman Masuk</Link></div>;
