  ...
  if (state.status === "success") {
    return (
      <div className="rounded-xl border border-primary/20 bg-primary/5 p-8 text-center" role="status">
        ...
        <p className="mt-5 text-label-sm text-on-surface-variant">Pendaftaran Anda telah tersimpan. Tim Kurata akan meninjau informasi yang diajukan. Jika disetujui, kami akan mengirim tautan untuk membuat password atau pemberitahuan ke akun Kurata Anda.</p>
      </div>
    );
  }
