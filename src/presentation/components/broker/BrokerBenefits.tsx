...
const BENEFITS: { icon: LucideIcon; title: string; description: string }[] = [
  ...
  { icon: Users, title: "Jaringan Profesional", description: "Terhubung dengan sesama Mitra Kurata dan tim Kurata untuk peluang kolaborasi." },
  ...
  return (
    <section className="container-main py-16 md:py-20" aria-labelledby="broker-benefits-title">
      <div className="max-w-2xl">
        ...
        <h2 id="broker-benefits-title" className="text-3xl font-bold text-on-surface">Dukungan untuk Mitra Kurata yang Serius Bertumbuh</h2>
        <p className="mt-3 text-body-md leading-7 text-on-surface-variant">Kurata dirancang untuk membantu Mitra Kurata membangun proses pemasaran tanah yang lebih profesional dan mudah dipercaya.</p>
      </div>
