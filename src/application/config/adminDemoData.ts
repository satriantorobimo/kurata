...
export const ADMIN_DEMO_DATA = {
  ...
  brokers: [
    { id: "BRK-M3K7-AP9Q", name: "Dimas Wibowo", email: "dimas@wibowoland.id", subtitle: "Wibowo Land · Broker independen", submittedAt: "Hari ini, 08.15", status: "pending", details: ["Area: Jakarta Selatan, Depok, Bogor", "Pengalaman: 3–5 tahun", "Spesialisasi: Tanah hunian, tanah komersial"] },
    ...
    { id: "BRK-A9K1-T8WX", name: "Fajar Nugroho", email: "fajar@tanahutama.id", subtitle: "Tanah Utama · Broker Partner", submittedAt: "18 Jul 2026", status: "verified", details: ["Area: Yogyakarta dan Sleman", "Status kemitraan: aktif", "12 listing aktif"] },
  ] satisfies ReviewRecord[],
  assets: [
