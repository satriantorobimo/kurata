import type { SupportCategoryDefinition, SupportFaq } from "../../application/config/supportContent";

/**
 * Seed content for the Kurata help center.
 ...
 */
export const SUPPORT_CATEGORIES_SEED: SupportCategoryDefinition[] = [
...
export const SUPPORT_FAQS_SEED: SupportFaq[] = [
  ...
  { id: "password-recovery", category: "account-security", question: "Bagaimana jika saya lupa password?", answer: "Pemulihan password belum aktif. Gunakan formulir bantuan untuk memberi tahu kami kebutuhan Anda; jangan kirim password saat ini atau sebelumnya." },
  { id: "account-demo", category: "account-security", question: "Apakah akun saya sudah tersimpan setelah mendaftar?", answer: "Ya. Saat Anda mendaftar, akun dan password disimpan dengan aman. Anda dapat langsung masuk menggunakan email dan password yang dibuat." },
