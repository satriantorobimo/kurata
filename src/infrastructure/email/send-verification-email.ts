...
function siteUrl(): string {
  return process.env.SITE_URL ?? "https://kurata.com";
}

function senderEmail(): string {
  return process.env.SMTP_USER ?? "noreply@kurata.com";
}
...
<body style="margin:0;padding:0;background-color:#f5f5f5;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;margin:32px auto;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,0.08);">
    <tr><td style="padding:32px 40px 0;text-align:center;"><span style="display:inline-block;width:44px;height:44px;background:#166534;border-radius:12px;color:#fff;font-size:20px;font-weight:700;line-height:44px;">K</span></td></tr>
